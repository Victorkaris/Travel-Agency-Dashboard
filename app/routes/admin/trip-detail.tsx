...
const TripDetail = ({ loaderData } : Route.ComponentProps) => {
    const imageUrl = loaderData?.trip?.imageUrl || '/assets/images/trip-placeholder.jpg';
    ...
    <main className='travel-detail wrapper'>
        ...
        <section className='container wrapper-md'>
            ...
            <p className='text-sm mdtext-lg font-normal text-dark-400'>{description}</p>
